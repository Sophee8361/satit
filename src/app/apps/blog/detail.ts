    ...
    <div class="card">
      <div class="flex justify-between flex-col-reverse md:flex-row items-center">
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <span
            class="mt-4 font-bold text-surface-900 dark:text-surface-0 text-center whitespace-nowrap">Jane Cooper</span>
        </div>
      </div>
      ...
      <p class="leading-normal text-lg mb-6">There&lsquo;s an old maxim that states, “No fun for the writer, no fun for
        the reader.”No matter what industry you&lsquo;re working in, as a blogger, you should live and die by this
        statement.</p>
      <p class="leading-normal text-lg mb-6">
      ...
      <div class="text-2xl text-surface-900 dark:text-surface-0 mb-6 font-semibold">Commodo ultrices orci tempus et
        fermentum, pellentesque ultricies.
      </div>
      <ul class="text-xl p-0 my-0 ml-8">
        ...
        <li class="mb-4 leading-normal">Enim in porta facilisi a vulputate fermentum, morbi. Consequat, id praesent
          tristique euismod pellentesque.
        </li>
        <li class="mb-4 leading-normal">Implements This is an external link</li>
        <li class="leading-normal">Scelerisque ultricies tincidunt lectus faucibus non morbi sed nibh varius. Quam a,
      ...
      <div class="flex items-center mb-6 font-bold">
        ...
        <span
          class="inline-flex items-center justify-center w-8 h-8 border border-surface-200 dark:border-surface-700 rounded">{{ comments.length }}</span>
      </div>
      <ul class="list-none p-0 m-0">
        <li *ngFor="let comment of comments; let i = index" [attr.key]="i"
