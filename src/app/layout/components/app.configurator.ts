...
@Component({
  ...
  template: `
    <p-drawer [visible]="visible()" (onHide)="onDrawerHide()" position="right"
              [transitionOptions]="'.3s cubic-bezier(0, 0, 0.2, 1)'" styleClass="layout-config-sidebar w-80"
              header="Settings">
              ...
              <div class="flex">
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="static" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('static')" inputId="static"></p-radio-button>
                  <label for="static">Static</label>
                </div>

                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="overlay" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('overlay')" inputId="overlay"></p-radio-button>
              ...
              <div class="flex">
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="slim" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('slim')" inputId="slim"></p-radio-button>
                  <label for="slim">Slim</label>
                </div>
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="compact" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('compact')" inputId="compact"></p-radio-button>
              ...
              <div class="flex">
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="reveal" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('reveal')" inputId="reveal"></p-radio-button>
                  <label for="reveal">Reveal</label>
                </div>
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="drawer" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('drawer')" inputId="drawer"></p-radio-button>
              ...
              <div class="flex">
                <div class="flex items-center gap-2 w-6/12">
                  <p-radio-button name="menuMode" value="horizontal" [(ngModel)]="menuMode"
                                  (ngModelChange)="setMenuMode('horizontal')" inputId="horizontal"></p-radio-button>
