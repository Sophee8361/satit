...
@Component({
  ...
  template: `
    <p-drawer header="Menu" [(visible)]="rightMenuVisible" position="right"
        ...
        <div class="flex flex-col mt-7">
          <div class="flex gap-6">
            ...
            <div class="mt-2">
              ...
              <p class="md:label-small mt-1">Richard Jones has purchased a blue t-shirt for <b
                class="body-small text-surface-950 dark:text-surface-0">$79</b></p>
            </div>
          </div>
          <div class="flex gap-6">
            <div class="flex flex-col items-center">
            ...
            <div class="mt-2">
              ...
              <p class="md:label-small mt-1">Your request for withdrawal of <b
                class="body-small text-surface-950 dark:text-surface-0">$2500</b> has been initiated.</p>
            </div>
          </div>
          <div class="flex gap-6">
            <div class="flex flex-col items-center">
            ...
            <div class="mt-2">
              ...
              <p class="md:label-small mt-1">Jane Davis has posted a <b
                class="body-small text-surface-950 dark:text-surface-0">new question</b> about your product.</p>
            </div>
          </div>
          <div class="flex gap-6">
            <div class="flex flex-col items-center">
            ...
            <div class="mt-2">
              ...
              <p class="md:label-small mt-1">Claire Smith has upvoted your store along with a <b
                class="body-small text-surface-950 dark:text-surface-0">comment.</b></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex flex-col gap-3.5 mt-7 mb-6">
          ...
          <p-select [(ngModel)]="selectedCard" [options]="cards" optionLabel="label" placeholder="Select a Card"
                    class="w-full"/>
        </div>
      ...
      <div>
        ...
        <img class="w-full h-full max-h-60 object-cover border border-surface rounded-2xl mt-4"
             src="/layout/images/sidebar-right/staticmap.png" alt="map"/>
      </div>
    </p-drawer>`
})
