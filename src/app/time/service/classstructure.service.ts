...
import { ClassStructure } from './model/classtime.model'; // Import SlotModel interface
...
export class ClassstructureService  {
  ...
  getSlot(): Observable<ClassStructure[]> {
  ...
  deleteClassstructure(id: string): Observable<any> {
